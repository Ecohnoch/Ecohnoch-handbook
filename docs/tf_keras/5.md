...
def aspp(input_tensor):
    ...
    # rate = 6
    x1 = Conv2D(256, (3, 3), name='aspp1', dilation_rate=6)(input_tensor)
    x1 = BatchNormalization(name='aspp1_bn')(x1)
    x1 = ReLU(name='aspp2_relu')(x1)

    # rate = 12
    x2 = Conv2D(256, (3, 3), name='aspp2', dilation_rate=12)(input_tensor)
    x2 = BatchNormalization(name='aspp2_bn')(x2)
    x2 = ReLU(name='aspp2_relu')(x2)

    # rate = 18
    x3 = Conv2D(256, (3, 3), name='aspp3', dilation_rate=18)(input_tensor)
